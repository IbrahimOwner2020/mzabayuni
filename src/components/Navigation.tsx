    ...
    return (
        <div className="max-w-7xl mx-auto bg-white py-6 px-4 flex items-center justify-between relative">
            <div className="flex justify-start items-center">
                ...
                <Link href="/">
                    <h2 className="cursor-pointer text-black font-bold text-xl mr-5">Jeremiah</h2>
                </Link>
                <Link href="/">
            ...
            {sideNav ? (
                <div className="sm:hidden fixed top-0 left-0 w-screen h-screen bg-primary z-20">
                    <ul className={`absolute left-1/2 transition-all duration-300 transform -translate-x-1/2 ${sideNav ? 'top-1/4' : 'opacity-0'}`}>
                        <li className="my-6">
                            <Link href="/resume">
                                <span className="cursor-pointer text-2xl text-black font-light px-6 py-6">Resume</span>
                            </Link>
                        </li>
                        <li className="my-6">
                            <Link href="/projects">
                                <span className="cursor-pointer text-2xl text-black font-light px-6 py-6">Projects</span>
                            </Link>
                        </li>
                        <li className="my-6">
                            <Link href="/contacts">
                                <span className="cursor-pointer text-2xl text-black font-light px-6 py-6">Contacts</span>
                            </Link>
                        </li>
                    </ul>
                </div>
            ...
            <div className="hidden sm:block">
                <ul className="flex">
                    <li className="mx-1 border-r-2 border-black">
                        <Link href="/resume">
                            <span className="cursor-pointer text-lg text-black px-2 font-light py-2">Resume</span>
                        </Link>
                    </li>
                    <li className="mx-1 border-r-2 border-black">
                        <Link href="/projects">
                            <span className="cursor-pointer text-lg text-black px-2 font-light py-2">Projects</span>
                        </Link>
                    </li>
                    <li className="mx-1">
                        <Link href="/contacts">
                            <span className="cursor-pointer text-lg text-black px-2 font-light py-2">Contacts</span>
                        </Link>
                    </li>
                </ul>
            </div>
